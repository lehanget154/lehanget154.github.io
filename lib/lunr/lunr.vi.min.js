...
lunr.vi=function(){this.pipeline.reset();this.pipeline.add(lunr.vi.stopWordFilter,lunr.vi.trimmer);};lunr.vi.wordCharacters="["+
"A-Za-z"+
"\u0300\u0350"+
"\u0301\u0351"+
"\u0309"+
...
"\u01A0-\u01A1"+
"\u01AF-\u01B0"+
"]";lunr.vi.trimmer=lunr.trimmerSupport.generateTrimmer(lunr.vi.wordCharacters);lunr.Pipeline.registerFunction(lunr.vi.trimmer,'trimmer-vi');lunr.vi.stopWordFilter=lunr.generateStopWordFilter('là cái nhưng mà'.split(' '));};}))